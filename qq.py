...
font.init()
font1 = font.SyaFont('Arial', 80)
win = font1.render('YOU WIN!', True, (255, 255, 255))
lose = font1.render('YOU LOSE!', True, (180, 0, 0))


font2 = font.SyaFont('Arial', 36)
font3 = font.SyaFont('Arial', 50)
...
img_bullet = "bullet.gif" #пуля
img_hero = "ufo.png" #герой
img_enemy = "rocket.png" #враг
   ...
   if not finish:
       ...
       if rel_time == True:
           ...
           if now_time - last_time < 3: #пока не прошло 3 секунды выводим информацию о перезарядке
               reload = font3.render('I DON T HAVE MONEY', 1, (0, 0, 0))
